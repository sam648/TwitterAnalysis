...
connectTwitter = function(){
  ...
  # setwd("C:/Users/Samriddhi/Desktop/R_Folder/Shiny")
  # d = read.table("Samriddhi_Twiiter_Analysis/www/T_C.txt", header =FALSE, sep= ",")
  #                # header = FALSE,
  #                # col.names=c("Credential", "Code")  )
  # 
  # consumer_key = d[1, ]['Code']
  # consumer_secret = d[2, ]['Code']
  # access_token = d[3, ]['Code']
  # access_secret =d[4, ]['Code']
